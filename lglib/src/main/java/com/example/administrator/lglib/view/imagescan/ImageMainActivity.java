		...
		public void handleMessage(Message msg) {
			...
			switch (msg.what) {
				case SCAN_OK:
					...
					adapter = new GroupAdapter(ImageMainActivity.this, list = subGroupOfImage(mGruopMap), mGroupGridView);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mGroupGridView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				mIntent.putExtra("click", true);
//				startActivity(mIntent);
				startActivityForResult(mIntent, AppParameters.SHOW_IMAGE_ACTIVITY_REQUEST_CODE);
			}
		});
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		switch (resultCode) {
			case AppParameters.SHOW_IMAGE_ACTIVITY_RESULT_CODE://子被点击之后返回的
				String path=data.getStringExtra("child_path");
				if(""!=path&&null!=path){
					setResult(AppParameters.SHOW_IMAGE_ACTIVITY_RESULT_CODE, data);
					finish();
				}
				break;
